...
extern int ph_increment(pam_handle_t *pamh, const cfg_t *opt, state *s);
...
extern int ph_init(pam_handle_t *pamh, int flags, int argc, const char **argv, cfg_t **opt, state **s);
